...
async function start_trial() {
    ...
    for (const conf of configurations) {
        ...
        configurations_trials.push([choice_width, choice_dist, difficulty_index_value, configuration_total_time, target_missed_clicks]);
    }
    ...
    csv_configuration += 'Targets width, Targets distance, Difficulty index (ID), Total time (ms), Total Missed Clicks\n';
...
async function run_configuration(current_width, current_dist) {
    ...
    var csv_trial = `Trial stats for user ${userid} targets of width ${current_width} and distance ${current_dist}:\n\n`;
    csv_trial += 'Time to reach target (ms),Missed clicks\n';
